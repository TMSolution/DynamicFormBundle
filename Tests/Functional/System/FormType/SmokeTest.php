...
namespace TMSolution\DynamicFormBundle\Tests\Functional\Model\System\FormType;
...
class SmokeTest extends CommandTestCase {
    ...
    protected static $entityClass='TMSolution\DynamicFormBundle\Entity\FormType';
    ...
    public function testCreate()
    {
        ...
        $form = $crawler->selectButton('create')->form([
                'system_form-type_insert[_token]'  => $this->getToken($crawler,'system_form-type_insert[_token]'),                
                'system_form-type_insert[name]'  => $entity->getName(),                
                'system_form-type_insert[technicalName]'  => $entity->getTechnicalName(),                
                'system_form-type_insert[className]'  => $entity->getClassName(),                
                'system_form-type_insert[parent]'  => $entity->getParent(),                
                'system_form-type_insert[active]'  => $entity->getActive(),                
                'system_form-type_insert[cssIconClass]'  => $entity->getCssIconClass(),    
        ]);
    ...
    public function testUpdate()
    {
        ...
        $form = $crawler->selectButton('update')->form([
                'system_form-type_edit[_token]'  => $this->getToken($crawler,'system_form-type_edit[_token]'),                
                'system_form-type_edit[name]'  => $entity->getName(),                
                'system_form-type_edit[technicalName]'  => $entity->getTechnicalName(),                
                'system_form-type_edit[className]'  => $entity->getClassName(),                
                'system_form-type_edit[parent]'  => $entity->getParent(),                
                'system_form-type_edit[active]'  => $entity->getActive(),                
                'system_form-type_edit[cssIconClass]'  => $entity->getCssIconClass(),    
        ]);
    ...
    {
        $route='/system/form-type/delete/1';
        $crawler = self::$client->request('GET', $route);
        $this->printError($crawler);
        $this->assertEquals(200, self::$client->getResponse()->getStatusCode(), sprintf("Unexpected HTTP status code for GET %s",$route)); 
    ...
    public function testDelete()
    {
        ...
        $form = $crawler->selectButton('delete')->form(array(
            'system_form-type_delete[_token]'  => $this->getToken($crawler,'system_form-type_delete[_token]'),
        ));
    ...
    public function testFilter()
    {
        ...
        [
            'system_form-type_filter' =>[                
                'name'  => $entity->getName(),                
                'technicalName'  => $entity->getTechnicalName(),                
                'className'  => $entity->getClassName(),                
                'parent'  => $entity->getParent(),                
                'formTypeOptions'  => $entity->getFormTypeOptions(),                
                'active'  => $entity->getActive(),                
                'cssIconClass'  => $entity->getCssIconClass(),                
                'formItems'  => $entity->getFormItems(), 
            ]
        ]);
    ...
    {
        $route='/system/form-type/typeahead/name';
        $entity=$this->getEntity();
        $crawler = self::$client->request('GET', $route,[
            'system_form-type_filter' =>[                
                'name'  => $entity->getName(),                
