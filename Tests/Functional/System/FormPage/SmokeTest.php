...
namespace TMSolution\DynamicFormBundle\Tests\Functional\Model\System\FormPage;
...
class SmokeTest extends CommandTestCase {
    ...
    protected static $entityClass='TMSolution\DynamicFormBundle\Entity\FormPage';
    ...
    public function testCreate()
    {
        ...
        $form = $crawler->selectButton('create')->form([
                'system_form-page_insert[_token]'  => $this->getToken($crawler,'system_form-page_insert[_token]'),                
                'system_form-page_insert[name]'  => $entity->getName(),                
                'system_form-page_insert[validateOnPageChange]'  => $entity->getValidateOnPageChange(),                
                'system_form-page_insert[saveOnPageChange]'  => $entity->getSaveOnPageChange(),    
        ]);
    ...
    public function testUpdate()
    {
        ...
        $form = $crawler->selectButton('update')->form([
                'system_form-page_edit[_token]'  => $this->getToken($crawler,'system_form-page_edit[_token]'),                
                'system_form-page_edit[name]'  => $entity->getName(),                
                'system_form-page_edit[validateOnPageChange]'  => $entity->getValidateOnPageChange(),                
                'system_form-page_edit[saveOnPageChange]'  => $entity->getSaveOnPageChange(),    
        ]);
    ...
    {
        $route='/system/form-page/delete/1';
        $crawler = self::$client->request('GET', $route);
        $this->printError($crawler);
        $this->assertEquals(200, self::$client->getResponse()->getStatusCode(), sprintf("Unexpected HTTP status code for GET %s",$route)); 
    ...
    public function testDelete()
    {
        ...
        $form = $crawler->selectButton('delete')->form(array(
            'system_form-page_delete[_token]'  => $this->getToken($crawler,'system_form-page_delete[_token]'),
        ));
    ...
    {
        $route='/system/form-page/typeahead/name';
        $entity=$this->getEntity();
        $crawler = self::$client->request('GET', $route,[
            'system_form-page_filter' =>[                
                'name'  => $entity->getName(),                
