...
use TMSolution\DynamicFormBundle\Model\System\FormPage\Model ;
...
class SmoekTest extends CommandTestCase {
    ...
    public function testUpdate() {
        ...
        $obj=$this->getEntity();
                ...
                $entity->setValidateOnPageChange($obj->getValidateOnPageChange());
                $entity->setSaveOnPageChange($obj->getSaveOnPageChange());        
