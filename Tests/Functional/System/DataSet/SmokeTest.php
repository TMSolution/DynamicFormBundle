...
namespace TMSolution\DynamicFormBundle\Tests\Functional\Model\System\DataSet;
...
class SmokeTest extends CommandTestCase {
    ...
    protected static $entityClass='TMSolution\DynamicFormBundle\Entity\DataSet';
    ...
    public function testCreate()
    {
        ...
        $form = $crawler->selectButton('create')->form([
                'system_data-set_insert[_token]'  => $this->getToken($crawler,'system_data-set_insert[_token]'),                
                'system_data-set_insert[creationDate]'  => $entity->getCreationDate()->format('d.m.Y'),                
                'system_data-set_insert[dataSet]'  => $entity->getDataSet(),                
                'system_data-set_insert[form]'  => $entity->getForm(),    
        ]);
    ...
    public function testUpdate()
    {
        ...
        $form = $crawler->selectButton('update')->form([
                'system_data-set_edit[_token]'  => $this->getToken($crawler,'system_data-set_edit[_token]'),                
                'system_data-set_edit[creationDate]'  => $entity->getCreationDate()->format('d.m.Y'),                
                'system_data-set_edit[dataSet]'  => $entity->getDataSet(),                
                'system_data-set_edit[form]'  => $entity->getForm(),    
        ]);
    ...
    {
        $route='/system/data-set/delete/1';
        $crawler = self::$client->request('GET', $route);
        $this->printError($crawler);
        $this->assertEquals(200, self::$client->getResponse()->getStatusCode(), sprintf("Unexpected HTTP status code for GET %s",$route)); 
    ...
    public function testDelete()
    {
        ...
        $form = $crawler->selectButton('delete')->form(array(
            'system_data-set_delete[_token]'  => $this->getToken($crawler,'system_data-set_delete[_token]'),
        ));
