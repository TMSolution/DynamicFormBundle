...
namespace TMSolution\DynamicFormBundle\Tests\Functional\Model\System\Form;
...
class SmokeTest extends CommandTestCase {
    ...
    protected static $entityClass='TMSolution\DynamicFormBundle\Entity\Form';
    ...
    public function testCreate()
    {
        ...
        $form = $crawler->selectButton('create')->form([
                'system_form_insert[_token]'  => $this->getToken($crawler,'system_form_insert[_token]'),                
                'system_form_insert[name]'  => $entity->getName(),    
        ]);
    ...
    public function testUpdate()
    {
        ...
        $form = $crawler->selectButton('update')->form([
                'system_form_edit[_token]'  => $this->getToken($crawler,'system_form_edit[_token]'),                
                'system_form_edit[name]'  => $entity->getName(),    
        ]);
    ...
    public function testDelete()
    {
        ...
        $form = $crawler->selectButton('delete')->form(array(
            'system_form_delete[_token]'  => $this->getToken($crawler,'system_form_delete[_token]'),
        ));
    ...
    {
        $route='/system/form/typeahead/name';
        $entity=$this->getEntity();
        $crawler = self::$client->request('GET', $route,[
            'system_form_filter' =>[                
                'name'  => $entity->getName(),                
