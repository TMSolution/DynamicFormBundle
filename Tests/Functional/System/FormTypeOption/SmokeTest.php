...
namespace TMSolution\DynamicFormBundle\Tests\Functional\Model\System\FormTypeOption;
...
class SmokeTest extends CommandTestCase {
    ...
    protected static $entityClass='TMSolution\DynamicFormBundle\Entity\FormTypeOption';
    ...
    {
        $route='/system/form-type-option/index';
        $crawler = self::$client->request('GET', $route);
    ...
    {
        $route='/system/form-type-option/new';
        $crawler = self::$client->request('GET', $route);
        $this->printError($crawler);
        $this->assertEquals(200, self::$client->getResponse()->getStatusCode(), sprintf("Unexpected HTTP status code for GET %s",$route));
    }
    ...
    public function testCreate()
    {
        ...
        $form = $crawler->selectButton('create')->form([
                'system_form-type-option_insert[_token]'  => $this->getToken($crawler,'system_form-type-option_insert[_token]'),                
                'system_form-type-option_insert[defaultValue]'  => $entity->getDefaultValue(),                
                'system_form-type-option_insert[formType]'  => $entity->getFormType(),                
                'system_form-type-option_insert[formTypeOptionDict]'  => $entity->getFormTypeOptionDict(),                
                'system_form-type-option_insert[dataTypes]'  => $entity->getDataTypes(),                
                'system_form-type-option_insert[optionRequired]'  => $entity->getOptionRequired(),                
                'system_form-type-option_insert[active]'  => $entity->getActive(),                
                'system_form-type-option_insert[position]'  => $entity->getPosition(),                
                'system_form-type-option_insert[isAdvanced]'  => $entity->getIsAdvanced(),    
        ]);
    ...
    {
        $route='/system/form-type-option/edit/1';
        $crawler = self::$client->request('GET', $route);
        $this->printError($crawler);
        $this->assertEquals(200, self::$client->getResponse()->getStatusCode(), sprintf("Unexpected HTTP status code for GET %s",$route));    
    }
    ...
    public function testUpdate()
    {
        ...
        $form = $crawler->selectButton('update')->form([
                'system_form-type-option_edit[_token]'  => $this->getToken($crawler,'system_form-type-option_edit[_token]'),                
                'system_form-type-option_edit[defaultValue]'  => $entity->getDefaultValue(),                
                'system_form-type-option_edit[formType]'  => $entity->getFormType(),                
                'system_form-type-option_edit[formTypeOptionDict]'  => $entity->getFormTypeOptionDict(),                
                'system_form-type-option_edit[dataTypes]'  => $entity->getDataTypes(),                
                'system_form-type-option_edit[optionRequired]'  => $entity->getOptionRequired(),                
                'system_form-type-option_edit[active]'  => $entity->getActive(),                
                'system_form-type-option_edit[position]'  => $entity->getPosition(),                
                'system_form-type-option_edit[isAdvanced]'  => $entity->getIsAdvanced(),    
        ]);
    ...
    {
        $route='/system/form-type-option/delete/1';
        $crawler = self::$client->request('GET', $route);
        $this->printError($crawler);
        $this->assertEquals(200, self::$client->getResponse()->getStatusCode(), sprintf("Unexpected HTTP status code for GET %s",$route)); 
    ...
    public function testDelete()
    {
        ...
        $form = $crawler->selectButton('delete')->form(array(
            'system_form-type-option_delete[_token]'  => $this->getToken($crawler,'system_form-type-option_delete[_token]'),
        ));
    ...
    {
        $route='/system/form-type-option/list';
    ...
    {
        $route='/system/form-type-option/filter';
        $crawler = self::$client->request('GET', $route,[],[],['HTTP_X-Requested-With' => 'XMLHttpRequest']);
        $this->printError($crawler);
        $this->assertEquals(200, self::$client->getResponse()->getStatusCode(), sprintf("Unexpected HTTP status code for GET %s",$route)); 
        $entity=$this->getEntity();
        ...
        [
            'system_form-type-option_filter' =>[                
                'defaultValue'  => $entity->getDefaultValue(),                
                'formType'  => $entity->getFormType(),                
                'formTypeOptionDict'  => $entity->getFormTypeOptionDict(),                
                'dataTypes'  => $entity->getDataTypes(),                
                'optionRequired'  => $entity->getOptionRequired(),                
                'active'  => $entity->getActive(),                
                'position'  => $entity->getPosition(),                
                'isAdvanced'  => $entity->getIsAdvanced(), 
            ]
        ]);
    ...
    {
        $route='/system/form-type-option/typeahead/defaultValue';
        $entity=$this->getEntity();
        $crawler = self::$client->request('GET', $route,[
            'system_form-type-option_filter' =>[                
                'defaultValue'  => $entity->getDefaultValue(),                
