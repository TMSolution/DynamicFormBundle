...
use TMSolution\DynamicFormBundle\Model\System\FormTypeOption\Model ;
...
class SmoekTest extends CommandTestCase {
    ...
    public function testUpdate() {
        ...
        $obj=$this->getEntity();
                $entity->setDefaultValue($obj->getDefaultValue());
                $entity->setFormType($obj->getFormType());
                $entity->setFormTypeOptionDict($obj->getFormTypeOptionDict());
                $entity->setOptionRequired($obj->getOptionRequired());
                $entity->setActive($obj->getActive());
                $entity->setPosition($obj->getPosition());
                $entity->setIsAdvanced($obj->getIsAdvanced());        
