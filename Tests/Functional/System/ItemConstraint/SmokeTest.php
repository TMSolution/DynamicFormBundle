...
namespace TMSolution\DynamicFormBundle\Tests\Functional\Model\System\ItemConstraint;
...
class SmokeTest extends CommandTestCase {
    ...
    protected static $entityClass='TMSolution\DynamicFormBundle\Entity\ItemConstraint';
    ...
    {
        $route='/system/item-constraint/index';
        $crawler = self::$client->request('GET', $route);
    ...
    {
        $route='/system/item-constraint/new';
        $crawler = self::$client->request('GET', $route);
        $this->printError($crawler);
        $this->assertEquals(200, self::$client->getResponse()->getStatusCode(), sprintf("Unexpected HTTP status code for GET %s",$route));
    }
    ...
    public function testCreate()
    {
        ...
        $form = $crawler->selectButton('create')->form([
                'system_item-constraint_insert[_token]'  => $this->getToken($crawler,'system_item-constraint_insert[_token]'),                
                'system_item-constraint_insert[item]'  => $entity->getItem(),                
                'system_item-constraint_insert[constraintDict]'  => $entity->getConstraintDict(),    
        ]);
    ...
    {
        $route='/system/item-constraint/edit/1';
        $crawler = self::$client->request('GET', $route);
        $this->printError($crawler);
        $this->assertEquals(200, self::$client->getResponse()->getStatusCode(), sprintf("Unexpected HTTP status code for GET %s",$route));    
    }
    ...
    public function testUpdate()
    {
        ...
        $form = $crawler->selectButton('update')->form([
                'system_item-constraint_edit[_token]'  => $this->getToken($crawler,'system_item-constraint_edit[_token]'),                
                'system_item-constraint_edit[item]'  => $entity->getItem(),                
                'system_item-constraint_edit[constraintDict]'  => $entity->getConstraintDict(),    
        ]);
    ...
    {
        $route='/system/item-constraint/delete/1';
        $crawler = self::$client->request('GET', $route);
        $this->printError($crawler);
        $this->assertEquals(200, self::$client->getResponse()->getStatusCode(), sprintf("Unexpected HTTP status code for GET %s",$route)); 
    ...
    public function testDelete()
    {
        ...
        $form = $crawler->selectButton('delete')->form(array(
            'system_item-constraint_delete[_token]'  => $this->getToken($crawler,'system_item-constraint_delete[_token]'),
        ));
    ...
    {
        $route='/system/item-constraint/list';
    ...
    {
        $route='/system/item-constraint/filter';
        $crawler = self::$client->request('GET', $route,[],[],['HTTP_X-Requested-With' => 'XMLHttpRequest']);
        $this->printError($crawler);
        $this->assertEquals(200, self::$client->getResponse()->getStatusCode(), sprintf("Unexpected HTTP status code for GET %s",$route)); 
        $entity=$this->getEntity();
        ...
        [
            'system_item-constraint_filter' =>[                
                'item'  => $entity->getItem(),                
                'constraintDict'  => $entity->getConstraintDict(), 
            ]
        ]);
