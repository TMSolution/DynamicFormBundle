...
namespace TMSolution\DynamicFormBundle\Tests\Functional\Model\System\FormDataSetItem;
...
class SmokeTest extends CommandTestCase {
    ...
    protected static $entityClass='TMSolution\DynamicFormBundle\Entity\FormDataSetItem';
    ...
    {
        $route='/system/form-data-set-item/index';
        $crawler = self::$client->request('GET', $route);
    ...
    {
        $route='/system/form-data-set-item/new';
        $crawler = self::$client->request('GET', $route);
        $this->printError($crawler);
        $this->assertEquals(200, self::$client->getResponse()->getStatusCode(), sprintf("Unexpected HTTP status code for GET %s",$route));
    }
    ...
    public function testCreate()
    {
        ...
        $form = $crawler->selectButton('create')->form([
                'system_form-data-set-item_insert[_token]'  => $this->getToken($crawler,'system_form-data-set-item_insert[_token]'),                
                'system_form-data-set-item_insert[value]'  => $entity->getValue(),    
        ]);
    ...
    {
        $route='/system/form-data-set-item/edit/1';
        $crawler = self::$client->request('GET', $route);
        $this->printError($crawler);
        $this->assertEquals(200, self::$client->getResponse()->getStatusCode(), sprintf("Unexpected HTTP status code for GET %s",$route));    
    }
    ...
    public function testUpdate()
    {
        ...
        $form = $crawler->selectButton('update')->form([
                'system_form-data-set-item_edit[_token]'  => $this->getToken($crawler,'system_form-data-set-item_edit[_token]'),                
                'system_form-data-set-item_edit[value]'  => $entity->getValue(),    
        ]);
    ...
    {
        $route='/system/form-data-set-item/delete/1';
        $crawler = self::$client->request('GET', $route);
        $this->printError($crawler);
        $this->assertEquals(200, self::$client->getResponse()->getStatusCode(), sprintf("Unexpected HTTP status code for GET %s",$route)); 
    ...
    public function testDelete()
    {
        ...
        $form = $crawler->selectButton('delete')->form(array(
            'system_form-data-set-item_delete[_token]'  => $this->getToken($crawler,'system_form-data-set-item_delete[_token]'),
        ));
    ...
    {
        $route='/system/form-data-set-item/list';
    ...
    {
        $route='/system/form-data-set-item/filter';
        $crawler = self::$client->request('GET', $route,[],[],['HTTP_X-Requested-With' => 'XMLHttpRequest']);
        $this->printError($crawler);
        $this->assertEquals(200, self::$client->getResponse()->getStatusCode(), sprintf("Unexpected HTTP status code for GET %s",$route)); 
        $entity=$this->getEntity();
        ...
        [
            'system_form-data-set-item_filter' =>[                
