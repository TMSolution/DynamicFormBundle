...
namespace TMSolution\DynamicFormBundle\Tests\Functional\Model\System\DynamicForm;
...
class SmokeTest extends CommandTestCase {
    ...
    protected static $entityClass='TMSolution\DynamicFormBundle\Entity\DynamicForm';
    ...
    {
        $route='/system/dynamic-form/index';
        $crawler = self::$client->request('GET', $route);
    ...
    public function testCreate()
    {
        ...
        $form = $crawler->selectButton('create')->form([
                'system_dynamic-form_insert[_token]'  => $this->getToken($crawler,'system_dynamic-form_insert[_token]'),                
                'system_dynamic-form_insert[name]'  => $entity->getName(),    
        ]);
    ...
    {
        $route='/system/dynamic-form/edit/1';
        $crawler = self::$client->request('GET', $route);
        $this->printError($crawler);
        $this->assertEquals(200, self::$client->getResponse()->getStatusCode(), sprintf("Unexpected HTTP status code for GET %s",$route));    
    }
    ...
    public function testUpdate()
    {
        ...
        $form = $crawler->selectButton('update')->form([
                'system_dynamic-form_edit[_token]'  => $this->getToken($crawler,'system_dynamic-form_edit[_token]'),                
                'system_dynamic-form_edit[name]'  => $entity->getName(),    
        ]);
    ...
    {
        $route='/system/dynamic-form/delete/1';
        $crawler = self::$client->request('GET', $route);
        $this->printError($crawler);
        $this->assertEquals(200, self::$client->getResponse()->getStatusCode(), sprintf("Unexpected HTTP status code for GET %s",$route)); 
    ...
    public function testDelete()
    {
        ...
        $form = $crawler->selectButton('delete')->form(array(
            'system_dynamic-form_delete[_token]'  => $this->getToken($crawler,'system_dynamic-form_delete[_token]'),
        ));
    ...
    {
        $route='/system/dynamic-form/list';
    ...
    {
        $route='/system/dynamic-form/filter';
        $crawler = self::$client->request('GET', $route,[],[],['HTTP_X-Requested-With' => 'XMLHttpRequest']);
        $this->printError($crawler);
        $this->assertEquals(200, self::$client->getResponse()->getStatusCode(), sprintf("Unexpected HTTP status code for GET %s",$route)); 
        $entity=$this->getEntity();
        ...
        [
            'system_dynamic-form_filter' =>[                
                'name'  => $entity->getName(),                
                'formPages'  => $entity->getFormPages(), 
            ]
        ]);
    ...
    {
        $route='/system/dynamic-form/typeahead/name';
        $entity=$this->getEntity();
        $crawler = self::$client->request('GET', $route,[
            'system_dynamic-form_filter' =>[                
                'name'  => $entity->getName(),                
