...
namespace TMSolution\DynamicFormBundle\Tests\Functional\Model\System\FormItemConstraint;
...
class SmokeTest extends CommandTestCase {
    ...
    protected static $entityClass='TMSolution\DynamicFormBundle\Entity\FormItemConstraint';
    ...
    {
        $route='/system/form-item-constraint/index';
        $crawler = self::$client->request('GET', $route);
    ...
    {
        $route='/system/form-item-constraint/new';
        $crawler = self::$client->request('GET', $route);
        $this->printError($crawler);
        $this->assertEquals(200, self::$client->getResponse()->getStatusCode(), sprintf("Unexpected HTTP status code for GET %s",$route));
    }
    ...
    public function testCreate()
    {
        ...
        $form = $crawler->selectButton('create')->form([
                'system_form-item-constraint_insert[_token]'  => $this->getToken($crawler,'system_form-item-constraint_insert[_token]'),                
                'system_form-item-constraint_insert[formItem]'  => $entity->getFormItem(),                
                'system_form-item-constraint_insert[constraint]'  => $entity->getConstraint(),    
        ]);
    ...
    {
        $route='/system/form-item-constraint/edit/1';
        $crawler = self::$client->request('GET', $route);
        $this->printError($crawler);
        $this->assertEquals(200, self::$client->getResponse()->getStatusCode(), sprintf("Unexpected HTTP status code for GET %s",$route));    
    }
    ...
    public function testUpdate()
    {
        ...
        $form = $crawler->selectButton('update')->form([
                'system_form-item-constraint_edit[_token]'  => $this->getToken($crawler,'system_form-item-constraint_edit[_token]'),                
                'system_form-item-constraint_edit[formItem]'  => $entity->getFormItem(),                
                'system_form-item-constraint_edit[constraint]'  => $entity->getConstraint(),    
        ]);
    ...
    {
        $route='/system/form-item-constraint/delete/1';
        $crawler = self::$client->request('GET', $route);
        $this->printError($crawler);
        $this->assertEquals(200, self::$client->getResponse()->getStatusCode(), sprintf("Unexpected HTTP status code for GET %s",$route)); 
    ...
    public function testDelete()
    {
        ...
        $form = $crawler->selectButton('delete')->form(array(
            'system_form-item-constraint_delete[_token]'  => $this->getToken($crawler,'system_form-item-constraint_delete[_token]'),
        ));
    ...
    {
        $route='/system/form-item-constraint/list';
    ...
    {
        $route='/system/form-item-constraint/filter';
        $crawler = self::$client->request('GET', $route,[],[],['HTTP_X-Requested-With' => 'XMLHttpRequest']);
        $this->printError($crawler);
        $this->assertEquals(200, self::$client->getResponse()->getStatusCode(), sprintf("Unexpected HTTP status code for GET %s",$route)); 
        $entity=$this->getEntity();
        ...
        [
            'system_form-item-constraint_filter' =>[                
                'formItem'  => $entity->getFormItem(),                
                'constraint'  => $entity->getConstraint(), 
            ]
        ]);
