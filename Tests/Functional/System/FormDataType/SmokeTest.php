...
namespace TMSolution\DynamicFormBundle\Tests\Functional\Model\System\FormDataType;
...
class SmokeTest extends CommandTestCase {
    ...
    protected static $entityClass='TMSolution\DynamicFormBundle\Entity\FormDataType';
    ...
    {
        $route='/system/form-data-type/index';
        $crawler = self::$client->request('GET', $route);
    ...
    {
        $route='/system/form-data-type/new';
        $crawler = self::$client->request('GET', $route);
        $this->printError($crawler);
        $this->assertEquals(200, self::$client->getResponse()->getStatusCode(), sprintf("Unexpected HTTP status code for GET %s",$route));
    }
    ...
    public function testCreate()
    {
        ...
        $form = $crawler->selectButton('create')->form([
                'system_form-data-type_insert[_token]'  => $this->getToken($crawler,'system_form-data-type_insert[_token]'),                
                'system_form-data-type_insert[name]'  => $entity->getName(),                
                'system_form-data-type_insert[technicalName]'  => $entity->getTechnicalName(),                
                'system_form-data-type_insert[formTypeOptions]'  => $entity->getFormTypeOptions(),    
        ]);
    ...
    {
        $route='/system/form-data-type/edit/1';
        $crawler = self::$client->request('GET', $route);
        $this->printError($crawler);
        $this->assertEquals(200, self::$client->getResponse()->getStatusCode(), sprintf("Unexpected HTTP status code for GET %s",$route));    
    }
    ...
    public function testUpdate()
    {
        ...
        $form = $crawler->selectButton('update')->form([
                'system_form-data-type_edit[_token]'  => $this->getToken($crawler,'system_form-data-type_edit[_token]'),                
                'system_form-data-type_edit[name]'  => $entity->getName(),                
                'system_form-data-type_edit[technicalName]'  => $entity->getTechnicalName(),                
                'system_form-data-type_edit[formTypeOptions]'  => $entity->getFormTypeOptions(),    
        ]);
    ...
    {
        $route='/system/form-data-type/delete/1';
        $crawler = self::$client->request('GET', $route);
        $this->printError($crawler);
        $this->assertEquals(200, self::$client->getResponse()->getStatusCode(), sprintf("Unexpected HTTP status code for GET %s",$route)); 
    ...
    public function testDelete()
    {
        ...
        $form = $crawler->selectButton('delete')->form(array(
            'system_form-data-type_delete[_token]'  => $this->getToken($crawler,'system_form-data-type_delete[_token]'),
        ));
    ...
    {
        $route='/system/form-data-type/list';
    ...
    {
        $route='/system/form-data-type/filter';
        $crawler = self::$client->request('GET', $route,[],[],['HTTP_X-Requested-With' => 'XMLHttpRequest']);
        $this->printError($crawler);
        $this->assertEquals(200, self::$client->getResponse()->getStatusCode(), sprintf("Unexpected HTTP status code for GET %s",$route)); 
        $entity=$this->getEntity();
    ...
    {
        $route='/system/form-data-type/typeahead/name';
        $entity=$this->getEntity();
        $crawler = self::$client->request('GET', $route,[
            'system_form-data-type_filter' =>[                
                'name'  => $entity->getName(),                
