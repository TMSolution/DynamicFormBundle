...
namespace TMSolution\DynamicFormBundle\Tests\Functional\Model\System\Constraint;
...
class SmokeTest extends CommandTestCase {
    ...
    protected static $entityClass='TMSolution\DynamicFormBundle\Entity\Constraint';
    ...
    public function testCreate()
    {
        ...
        $form = $crawler->selectButton('create')->form([
                'system_constraint_insert[_token]'  => $this->getToken($crawler,'system_constraint_insert[_token]'),                
                'system_constraint_insert[name]'  => $entity->getName(),                
                'system_constraint_insert[technicalName]'  => $entity->getTechnicalName(),                
                'system_constraint_insert[constraintCategory]'  => $entity->getConstraintCategory(),    
        ]);
    ...
    {
        $route='/system/constraint/edit/1';
        $crawler = self::$client->request('GET', $route);
        $this->printError($crawler);
        $this->assertEquals(200, self::$client->getResponse()->getStatusCode(), sprintf("Unexpected HTTP status code for GET %s",$route));    
    }
    ...
    public function testUpdate()
    {
        ...
        $form = $crawler->selectButton('update')->form([
                'system_constraint_edit[_token]'  => $this->getToken($crawler,'system_constraint_edit[_token]'),                
                'system_constraint_edit[name]'  => $entity->getName(),                
                'system_constraint_edit[technicalName]'  => $entity->getTechnicalName(),                
                'system_constraint_edit[constraintCategory]'  => $entity->getConstraintCategory(),    
        ]);
    ...
    {
        $route='/system/constraint/delete/1';
        $crawler = self::$client->request('GET', $route);
        $this->printError($crawler);
        $this->assertEquals(200, self::$client->getResponse()->getStatusCode(), sprintf("Unexpected HTTP status code for GET %s",$route)); 
    ...
    public function testDelete()
    {
        ...
        $form = $crawler->selectButton('delete')->form(array(
            'system_constraint_delete[_token]'  => $this->getToken($crawler,'system_constraint_delete[_token]'),
        ));
    ...
    {
        $route='/system/constraint/filter';
        $crawler = self::$client->request('GET', $route,[],[],['HTTP_X-Requested-With' => 'XMLHttpRequest']);
        $this->printError($crawler);
        $this->assertEquals(200, self::$client->getResponse()->getStatusCode(), sprintf("Unexpected HTTP status code for GET %s",$route)); 
        $entity=$this->getEntity();
        ...
        [
            'system_constraint_filter' =>[                
                'name'  => $entity->getName(),                
                'technicalName'  => $entity->getTechnicalName(),                
                'constraintCategory'  => $entity->getConstraintCategory(), 
            ]
        ]);
    ...
    {
        $route='/system/constraint/typeahead/name';
        $entity=$this->getEntity();
        $crawler = self::$client->request('GET', $route,[
            'system_constraint_filter' =>[                
                'name'  => $entity->getName(),                
