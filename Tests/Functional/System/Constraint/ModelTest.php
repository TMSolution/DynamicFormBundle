...
use TMSolution\DynamicFormBundle\Model\System\Constraint\Model ;
...
class SmoekTest extends CommandTestCase {
    ...
    public function testUpdate() {
        ...
        $obj=$this->getEntity();
                ...
                $entity->setTechnicalName($obj->getTechnicalName());
                $entity->setOptions($obj->getOptions());
                $entity->setConstraintCategory($obj->getConstraintCategory());        
