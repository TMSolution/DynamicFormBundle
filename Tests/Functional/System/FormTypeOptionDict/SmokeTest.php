...
namespace TMSolution\DynamicFormBundle\Tests\Functional\Model\System\FormTypeOptionDict;
...
class SmokeTest extends CommandTestCase {
    ...
    protected static $entityClass='TMSolution\DynamicFormBundle\Entity\FormTypeOptionDict';
    ...
    {
        $route='/system/form-type-option-dict/index';
        $crawler = self::$client->request('GET', $route);
    ...
    {
        $route='/system/form-type-option-dict/new';
        $crawler = self::$client->request('GET', $route);
        $this->printError($crawler);
        $this->assertEquals(200, self::$client->getResponse()->getStatusCode(), sprintf("Unexpected HTTP status code for GET %s",$route));
    }
    ...
    public function testCreate()
    {
        ...
        $form = $crawler->selectButton('create')->form([
                'system_form-type-option-dict_insert[_token]'  => $this->getToken($crawler,'system_form-type-option-dict_insert[_token]'),                
                'system_form-type-option-dict_insert[name]'  => $entity->getName(),                
                'system_form-type-option-dict_insert[technicalName]'  => $entity->getTechnicalName(),                
                'system_form-type-option-dict_insert[formTypeOptions]'  => $entity->getFormTypeOptions(),    
        ]);
    ...
    {
        $route='/system/form-type-option-dict/edit/1';
        $crawler = self::$client->request('GET', $route);
        $this->printError($crawler);
        $this->assertEquals(200, self::$client->getResponse()->getStatusCode(), sprintf("Unexpected HTTP status code for GET %s",$route));    
    }
    ...
    public function testUpdate()
    {
        ...
        $form = $crawler->selectButton('update')->form([
                'system_form-type-option-dict_edit[_token]'  => $this->getToken($crawler,'system_form-type-option-dict_edit[_token]'),                
                'system_form-type-option-dict_edit[name]'  => $entity->getName(),                
                'system_form-type-option-dict_edit[technicalName]'  => $entity->getTechnicalName(),                
                'system_form-type-option-dict_edit[formTypeOptions]'  => $entity->getFormTypeOptions(),    
        ]);
    ...
    {
        $route='/system/form-type-option-dict/delete/1';
        $crawler = self::$client->request('GET', $route);
        $this->printError($crawler);
        $this->assertEquals(200, self::$client->getResponse()->getStatusCode(), sprintf("Unexpected HTTP status code for GET %s",$route)); 
    ...
    public function testDelete()
    {
        ...
        $form = $crawler->selectButton('delete')->form(array(
            'system_form-type-option-dict_delete[_token]'  => $this->getToken($crawler,'system_form-type-option-dict_delete[_token]'),
        ));
    ...
    {
        $route='/system/form-type-option-dict/list';
    ...
    {
        $route='/system/form-type-option-dict/filter';
        $crawler = self::$client->request('GET', $route,[],[],['HTTP_X-Requested-With' => 'XMLHttpRequest']);
        $this->printError($crawler);
        $this->assertEquals(200, self::$client->getResponse()->getStatusCode(), sprintf("Unexpected HTTP status code for GET %s",$route)); 
        $entity=$this->getEntity();
        ...
        [
            'system_form-type-option-dict_filter' =>[                
                'name'  => $entity->getName(),                
    ...
    {
        $route='/system/form-type-option-dict/typeahead/name';
        $entity=$this->getEntity();
        $crawler = self::$client->request('GET', $route,[
            'system_form-type-option-dict_filter' =>[                
                'name'  => $entity->getName(),                
