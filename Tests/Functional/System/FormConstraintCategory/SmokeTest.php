...
namespace TMSolution\DynamicFormBundle\Tests\Functional\Model\System\FormConstraintCategory;
...
class SmokeTest extends CommandTestCase {
    ...
    protected static $entityClass='TMSolution\DynamicFormBundle\Entity\FormConstraintCategory';
    ...
    {
        $route='/system/form-constraint-category/index';
        $crawler = self::$client->request('GET', $route);
    ...
    {
        $route='/system/form-constraint-category/new';
        $crawler = self::$client->request('GET', $route);
        $this->printError($crawler);
        $this->assertEquals(200, self::$client->getResponse()->getStatusCode(), sprintf("Unexpected HTTP status code for GET %s",$route));
    }
    ...
    public function testCreate()
    {
        ...
        $form = $crawler->selectButton('create')->form([
                'system_form-constraint-category_insert[_token]'  => $this->getToken($crawler,'system_form-constraint-category_insert[_token]'),                
                'system_form-constraint-category_insert[name]'  => $entity->getName(),    
        ]);
    ...
    {
        $route='/system/form-constraint-category/edit/1';
        $crawler = self::$client->request('GET', $route);
        $this->printError($crawler);
        $this->assertEquals(200, self::$client->getResponse()->getStatusCode(), sprintf("Unexpected HTTP status code for GET %s",$route));    
    }
    ...
    public function testUpdate()
    {
        ...
        $form = $crawler->selectButton('update')->form([
                'system_form-constraint-category_edit[_token]'  => $this->getToken($crawler,'system_form-constraint-category_edit[_token]'),                
                'system_form-constraint-category_edit[name]'  => $entity->getName(),    
        ]);
    ...
    {
        $route='/system/form-constraint-category/delete/1';
        $crawler = self::$client->request('GET', $route);
        $this->printError($crawler);
        $this->assertEquals(200, self::$client->getResponse()->getStatusCode(), sprintf("Unexpected HTTP status code for GET %s",$route)); 
    ...
    public function testDelete()
    {
        ...
        $form = $crawler->selectButton('delete')->form(array(
            'system_form-constraint-category_delete[_token]'  => $this->getToken($crawler,'system_form-constraint-category_delete[_token]'),
        ));
    ...
    {
        $route='/system/form-constraint-category/list';
    ...
    {
        $route='/system/form-constraint-category/filter';
        $crawler = self::$client->request('GET', $route,[],[],['HTTP_X-Requested-With' => 'XMLHttpRequest']);
        $this->printError($crawler);
        $this->assertEquals(200, self::$client->getResponse()->getStatusCode(), sprintf("Unexpected HTTP status code for GET %s",$route)); 
        $entity=$this->getEntity();
        ...
        [
            'system_form-constraint-category_filter' =>[                
                'name'  => $entity->getName(),                
                'formConstraints'  => $entity->getFormConstraints(), 
            ]
        ]);
    ...
    {
        $route='/system/form-constraint-category/typeahead/name';
        $entity=$this->getEntity();
        $crawler = self::$client->request('GET', $route,[
            'system_form-constraint-category_filter' =>[                
                'name'  => $entity->getName(),                
