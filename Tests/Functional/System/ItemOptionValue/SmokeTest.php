...
namespace TMSolution\DynamicFormBundle\Tests\Functional\Model\System\ItemOptionValue;
...
class SmokeTest extends CommandTestCase {
    ...
    protected static $entityClass='TMSolution\DynamicFormBundle\Entity\ItemOptionValue';
    ...
    {
        $route='/system/item-option-value/index';
        $crawler = self::$client->request('GET', $route);
    ...
    {
        $route='/system/item-option-value/new';
        $crawler = self::$client->request('GET', $route);
        $this->printError($crawler);
        $this->assertEquals(200, self::$client->getResponse()->getStatusCode(), sprintf("Unexpected HTTP status code for GET %s",$route));
    }
    ...
    public function testCreate()
    {
        ...
        $form = $crawler->selectButton('create')->form([
                'system_item-option-value_insert[_token]'  => $this->getToken($crawler,'system_item-option-value_insert[_token]'),                
                'system_item-option-value_insert[value]'  => $entity->getValue(),                
                'system_item-option-value_insert[item]'  => $entity->getItem(),                
                'system_item-option-value_insert[formTypeOption]'  => $entity->getFormTypeOption(),    
        ]);
    ...
    {
        $route='/system/item-option-value/edit/1';
        $crawler = self::$client->request('GET', $route);
        $this->printError($crawler);
        $this->assertEquals(200, self::$client->getResponse()->getStatusCode(), sprintf("Unexpected HTTP status code for GET %s",$route));    
    }
    ...
    public function testUpdate()
    {
        ...
        $form = $crawler->selectButton('update')->form([
                'system_item-option-value_edit[_token]'  => $this->getToken($crawler,'system_item-option-value_edit[_token]'),                
                'system_item-option-value_edit[value]'  => $entity->getValue(),                
                'system_item-option-value_edit[item]'  => $entity->getItem(),                
                'system_item-option-value_edit[formTypeOption]'  => $entity->getFormTypeOption(),    
        ]);
    ...
    {
        $route='/system/item-option-value/delete/1';
        $crawler = self::$client->request('GET', $route);
        $this->printError($crawler);
        $this->assertEquals(200, self::$client->getResponse()->getStatusCode(), sprintf("Unexpected HTTP status code for GET %s",$route)); 
    ...
    public function testDelete()
    {
        ...
        $form = $crawler->selectButton('delete')->form(array(
            'system_item-option-value_delete[_token]'  => $this->getToken($crawler,'system_item-option-value_delete[_token]'),
        ));
    ...
    {
        $route='/system/item-option-value/list';
    ...
    {
        $route='/system/item-option-value/filter';
        $crawler = self::$client->request('GET', $route,[],[],['HTTP_X-Requested-With' => 'XMLHttpRequest']);
        $this->printError($crawler);
        $this->assertEquals(200, self::$client->getResponse()->getStatusCode(), sprintf("Unexpected HTTP status code for GET %s",$route)); 
        $entity=$this->getEntity();
        ...
        [
            'system_item-option-value_filter' =>[                
    ...
    {
        $route='/system/item-option-value/typeahead/value';
        $entity=$this->getEntity();
        $crawler = self::$client->request('GET', $route,[
            'system_item-option-value_filter' =>[                
                'value'  => $entity->getValue(),                
