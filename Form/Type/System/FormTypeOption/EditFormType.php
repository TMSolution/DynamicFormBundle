...
class EditFormType extends ContextType
{
    ...
    {
        $builder            
            ->add('defaultValue',null,  ['label' => 'system.form_type_option.default_value','constraints' => []])->add('formType', Select2EntityType::class, [
                        'multiple' => false,
            ...
            ->add('optionRequired',null,  ['label' => 'system.form_type_option.option_required','constraints' => []])            
            ->add('active',null,  ['label' => 'system.form_type_option.active','constraints' => []])            
            ->add('position',null,  ['label' => 'system.form_type_option.position','constraints' => []])            
            ->add('isAdvanced',null,  ['label' => 'system.form_type_option.is_advanced','constraints' => []]);          
                ...
                $builder->add('formTypeOptionDict', HiddenEntityType::class, [
                    ...
                    'class' => 'TMSolution\DynamicFormBundle\Entity\FormTypeOptionDict','data' =>  $this->entityManager->getRepository('TMSolution\DynamicFormBundle\Entity\FormTypeOptionDict')->findOneById($this->context->get('formTypeOptionDict')),'empty_data' => NULL,
                    'required' => false,
                    'constraints' => [new Constraints\NotBlank()]
                ]);
    ...
    {
        return 'system_form_type_option_edit';
    }
