...
namespace TMSolution\DynamicFormBundle\Form\Type\System\FormConstraintCategory;
...
class FilterFormType extends ContextType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        ->add('id',Filters\NumberFilterType::class, ['label' => 'system.form_constraint_category.id'])                
                ->add('name',Filters\TextFilterType::class, ['label' => 'system.form_constraint_category.name']);
    ...
    {
        return 'system_form_constraint_category_filter';
    }
