...
class InsertFormType extends ContextType
{
        ...
        $builder            
            ->add('options',null,  ['label' => 'system.form_item_constraint.options','constraints' => []])->add('formItem', Select2EntityType::class, [
                ...
                $builder->add('constraint', HiddenEntityType::class, [
                    ...
                    'class' => 'TMSolution\DynamicFormBundle\Entity\FormConstraint','data' =>  $this->entityManager->getRepository('TMSolution\DynamicFormBundle\Entity\FormConstraint')->findOneById($this->context->get('constraint')),'required' => false,
                    'constraints' => [new Constraints\NotBlank()]
                ]);
    ...
    {
        return 'system_form_item_constraint_insert';
    }
