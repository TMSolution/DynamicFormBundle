...
class EditFormType extends ContextType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder            
            ->add('creationDate', DateTimeType::class, 
                        ...
                        'format' => 'dd.MM.yyyy',
                        'constraints' => [ 
                        new Constraints\DateTime(),new Constraints\NotBlank()]
                        ])            
            ->add('formDataSet',null,  ['label' => 'system.form_data_set.form_data_set','constraints' => []])->add('dynamicForm', Select2EntityType::class, [
                        'multiple' => false,
    ...
    {
        return 'system_form_data_set_edit';
    }
