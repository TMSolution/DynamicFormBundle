...
class EditFormType extends ContextType
{
    ...
    {
        $builder            
            ->add('name',null,  ['label' => 'system.form_type_option_dict.name','constraints' => [new Constraints\NotBlank()]])            
            ->add('technicalName',null,  ['label' => 'system.form_type_option_dict.technical_name','constraints' => [new Constraints\NotBlank()]]);          
    ...
    {
        return 'system_form_type_option_dict_edit';
    }
