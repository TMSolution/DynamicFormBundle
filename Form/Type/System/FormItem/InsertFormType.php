...
class InsertFormType extends ContextType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder            ->add('name',null,  ['label' => 'system.form_item.name','constraints' => []])->add('formType', Select2EntityType::class, [
                        'multiple' => false,
                        ...
                        // 'object_manager' => $objectManager, // inject a custom object / entity manager 
                    ])            ->add('position',null,  ['label' => 'system.form_item.position','constraints' => []])            ->add('required',null,  ['label' => 'system.form_item.required','constraints' => []]);
                ...
                $builder->add('formPage', HiddenEntityType::class, [
                    ...
                    'class' => 'TMSolution\DynamicFormBundle\Entity\FormPage','data' =>  $this->entityManager->getRepository('TMSolution\DynamicFormBundle\Entity\FormPage')->findOneById($this->context->get('formPage')),'required' => false,
                    'constraints' => [new Constraints\NotBlank()]
                ]);
    ...
    {
        return 'system_form_item_insert';
    }
