...
class FilterFormType extends ContextType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        ->add('id',Filters\NumberFilterType::class, ['label' => 'system.form_data_set_item.id'])                
                ->add('value',Filters\TextFilterType::class, ['label' => 'system.form_data_set_item.value']);
    ...
    {
        return 'system_form_data_set_item_filter';
    }
