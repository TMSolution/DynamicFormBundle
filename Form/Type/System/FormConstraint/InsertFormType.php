...
class InsertFormType extends ContextType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder            ->add('name',null,  ['label' => 'system.form_constraint.name','constraints' => []])            ->add('technicalName',null,  ['label' => 'system.form_constraint.technical_name','constraints' => []])            
            ->add('options',null,  ['label' => 'system.form_constraint.options','constraints' => []])->add('formConstraintCategory', Select2EntityType::class, [
                ...
                $builder->add('formConstraintCategory', HiddenEntityType::class, [
                    ...
                    'class' => 'TMSolution\DynamicFormBundle\Entity\FormConstraintCategory','data' =>  $this->entityManager->getRepository('TMSolution\DynamicFormBundle\Entity\FormConstraintCategory')->findOneById($this->context->get('formConstraintCategory')),'required' => false,
    ...
    {
        return 'system_form_constraint_insert';
    }
