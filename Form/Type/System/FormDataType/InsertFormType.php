...
class InsertFormType extends ContextType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder            ->add('name',null,  ['label' => 'system.form_data_type.name','constraints' => [new Constraints\NotBlank()]])            ->add('technicalName',null,  ['label' => 'system.form_data_type.technical_name','constraints' => [new Constraints\NotBlank()]]);
    ...
    {
        return 'system_form_data_type_insert';
    }
