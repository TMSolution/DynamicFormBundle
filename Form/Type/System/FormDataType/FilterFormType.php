...
class FilterFormType extends ContextType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        ->add('id',Filters\NumberFilterType::class, ['label' => 'system.form_data_type.id'])                
                ->add('name',Filters\TextFilterType::class, ['label' => 'system.form_data_type.name'])                
                ->add('technicalName',Filters\TextFilterType::class, ['label' => 'system.form_data_type.technical_name']);
            ...
            else
            {
                ...
                $builder->add('formTypeOptions', Select2EntityType::class, [
                        ...
                        'language' => 'pl',
                        'placeholder' => 'system.form_data_type.form_type_options',
    ...
    {
        return 'system_form_data_type_filter';
    }
