...
class InsertFormType extends ContextType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder            ->add('value',null,  ['label' => 'system.form_item_option_value.value','constraints' => []])->add('formItem', Select2EntityType::class, [
                        'multiple' => false,
                ...
                $builder->add('formItem', HiddenEntityType::class, [
                    ...
                    'class' => 'TMSolution\DynamicFormBundle\Entity\FormItem','data' =>  $this->entityManager->getRepository('TMSolution\DynamicFormBundle\Entity\FormItem')->findOneById($this->context->get('formItem')),'required' => false,
                ...
                $builder->add('formTypeOption', HiddenEntityType::class, [
                    ...
                    'class' => 'TMSolution\DynamicFormBundle\Entity\FormTypeOption','data' =>  $this->entityManager->getRepository('TMSolution\DynamicFormBundle\Entity\FormTypeOption')->findOneById($this->context->get('formTypeOption')),'required' => false,
                    'constraints' => [new Constraints\NotBlank()]
                ]);
    ...
    {
        return 'system_form_item_option_value_insert';
    }
