...
/**
 * @ORM\Entity()
 * @ORM\Table(name="dynamic_form_type_option_dict")
 */
class FormTypeOptionDict {
    ...
    /**
     * @ORM\ManyToMany(targetEntity="FormTypeOption", mappedBy="formTypeOptionDict") 
     */
